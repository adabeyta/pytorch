...
///
/// Creates a CPU tensor backed by the contents of the file at filename.
/// When shared is true the file is memory mapped with MAP_SHARED so writes
/// to the tensor are written back to the file. size is the number of
/// elements to read, so the file must hold at least size elements of dtype.
///
/// Minimum compatible version: PyTorch 2.10.
/// Build time minimum version: PyTorch 2.15.
///
/// @param filename Path of the file to read.
/// @param shared Optional flag to share the mapping with the file.
