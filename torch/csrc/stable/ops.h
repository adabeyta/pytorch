...
///
/// Performs a matrix multiplication of the 2-D tensors self and mat2,
/// storing the result in the provided output tensor. Following C++
/// convention, the out parameter comes first.
///
/// Minimum compatible version: PyTorch 2.10.
...
///
/// Performs a batch matrix multiplication of the 3-D tensors self and mat2,
/// storing the result in the provided output tensor. Following C++
/// convention, the out parameter comes first.
///
/// Minimum compatible version: PyTorch 2.10.
